...
public class Sound_MeasuringSystem {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while (ready.equals("Yes")){
            System.out.println(ANSI_Colors.CYAN_BOLD_BRIGHT);
            System.out.println("           .==============.");
            System.out.println(" __________||_{########}_||__________");
            System.out.println("|(O)____ : [FM 103.7] ooooo : ____(O)|");
            System.out.println("|  {::::}:  _________  +|+  :{::::}  | -=<");
            System.out.println("|  {;;;;}: |    |    | |+|  :{;;;;}  |");
            System.out.println("|________:_ooooo+==ooo______:________|");

            System.out.println(ANSI_Colors.RED_BOLD_BRIGHT + "Welcome to the Sound Frequency Measuring System");
            Thread.sleep(2000);
            System.out.println(ANSI_Colors.RED_BOLD_BRIGHT + "Please enter the information below: ->");
            Thread.sleep(1000);
            ...
            if (user_response.equals("A")){
                ...
                System.out.println(ANSI_Colors.BLUE_BOLD_BRIGHT + "Sorry, you have entered an incorrect option");
            }
            System.out.println(ANSI_Colors.RESET + "The observed sound frequency in Hertz(F`) is " + Math.ceil(obs_freq));
